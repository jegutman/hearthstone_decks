...
if __name__ == '__main__':
    ...
    lineups_to_test = [
        "Secret Mage,Murloc Paladin,Combo Priest,Cube Warlock".split(','),
        "Spell Hunter,OTK DK Paladin,Combo Priest,Cube Warlock".split(','),
        "Secret Mage,Combo Priest,Token Shaman,Cube Warlock".split(','),
        "Secret Mage,Murloc Paladin,Combo Priest,Zoo Warlock".split(','),
        #"Aggro Druid,Secret Mage,Murloc Paladin,Zoo Warlock".split(','),
        "Secret Mage,OTK DK Paladin,Combo Priest,Control Warlock".split(','),
        "Secret Mage,OTK DK Paladin,Spiteful Priest,Cube Warlock".split(','),
        "Big Spell Mage,OTK DK Paladin,Control Priest,Control Warlock".split(','),
        "Spell Hunter,Silver Hand Paladin,Control Priest,Cube Warlock".split(','),
        "Spell Hunter,Murloc Paladin,Token Shaman,Cube Warlock".split(','),
        "Secret Mage,Murloc Paladin,Control Priest,Cube Warlock".split(','),
        "Secret Mage,Murloc Paladin,Combo Priest,Zoo Warlock".split(','),
        "Secret Mage,Silver Hand Paladin,Spiteful Priest,Cube Warlock".split(','),
        "Secret Mage,Combo Priest,Quest Rogue,Cube Warlock".split(','),
        "Spell Hunter,Silver Hand Paladin,Control Priest,Cube Warlock".split(','),
        "Secret Mage,Silver Hand Paladin,Combo Priest,Zoo Warlock".split(','),
        "Secret Mage,Silver Hand Paladin,Combo Priest,Cube Warlock".split(','),
        "Secret Mage,Silver Hand Paladin,Spiteful Priest,Cube Warlock".split(','),
        "Spell Hunter,Silver Hand Paladin,Control Priest,Cube Warlock".split(','),
        "Secret Mage,Murloc Paladin,Spiteful Priest,Zoo Warlock".split(','),
        "Secret Mage,Murloc Paladin,Combo Priest,Zoo Warlock".split(','),
        "Secret Mage,Spiteful Priest,Quest Rogue,Cube Warlock".split(','),
        "Secret Mage,Combo Priest,Quest Rogue,Cube Warlock".split(','),
        #"Quest Mage,Combo Priest,Kingsbane Rogue,Cube Warlock".split(','),
        "Big Spell Mage,OTK DK Paladin,Control Priest,Control Warlock".split(','),
        "Spell Hunter,Silver Hand Paladin,Combo Priest,Cube Warlock".split(','),
        #"Quest Mage,Combo Priest,Quest Rogue,Cube Warlock".split(','),
        #"Quest Mage,Spiteful Priest,Quest Rogue,Cube Warlock".split(','),
        "Secret Mage,Spiteful Priest,Quest Rogue,Cube Warlock".split(','),
        "Spell Hunter,Murloc Paladin,Spiteful Priest,Cube Warlock".split(','),
        #"Spiteful Druid,Big Spell Mage,Combo Priest,Cube Warlock".split(','),
        "Secret Mage,Silver Hand Paladin,Control Priest,Cube Warlock".split(','),
    ]
