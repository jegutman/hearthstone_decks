...
cursor.execute("SELECT game_id FROM hsreplay.hsreplay join hsreplay.hsreplay_decks using(game_id) WHERE p1_deck_code = '' or p2_deck_code = '' or known_p1_deck_code = '' or known_p2_deck_code = ''")
game_ids = [i for (i,) in cursor.fetchall()]
...
#to_update = ['ZZzpSWwwwwp7DtbEp8DEw2']
